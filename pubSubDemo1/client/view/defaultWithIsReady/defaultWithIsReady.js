/**
 * defaultWithIsReady Template lifecycle methods
 */
Template.defaultWithIsReady.onCreated(function() {
  this.subscribe('defaultData');
});

Template.defaultWithIsReady.onRendered(function() {
  $('tbody').selectable({
    filter:':not(td)',
...
/**
 * defaultWithIsReady Template helpers/events
 */
Template.defaultWithIsReady.helpers({
  dataElems: function() {
...
Template.defaultWithIsReady.events({
